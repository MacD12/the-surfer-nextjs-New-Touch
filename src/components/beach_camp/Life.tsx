...
import { Sparkles, Award, Waves, Heart } from 'lucide-react';
import { useTranslation } from '@/lib/i18n-compat';

const STATS = [
  { value: '10+', label: 'Years of surf hospitality', Icon: Heart },
  { value: '6×', label: "Tripadvisor Travellers' Choice", Icon: Award },
  { value: 'ISA', label: 'Certified surf instructors', Icon: Waves },
];

const LifeAtSurfCamp = () => {
  const { t } = useTranslation();
  const title = t('lifeAtSurfCamp.title');
  const paragraphs = t('lifeAtSurfCamp.paragraphs', { returnObjects: true }) as string[];
          ...
          {STATS.map((s, i) => (
            ...
            >
              ...
              <div className="min-w-0">
                <span className="block font-[montserrat] text-lg sm:text-xl font-bold tracking-tight text-gray-900 tabular-nums leading-tight">
                  {s.value}
                </span>
