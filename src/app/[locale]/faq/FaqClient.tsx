      ...
      >
        ...
        <div className="container relative z-10 text-center mx-auto py-4 px-4 sm:px-6 md:px-20 lg:px-32 text-white">
          <motion.h1
            ...
            className="font-[montserrat] text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[120px] inline-block max-w-full sm:max-w-3xl font-bold tracking-tight leading-[1.02] pt-18 mt-16 sm:mt-8 md:-mt-2 drop-shadow-[0_4px_24px_rgba(0,0,0,0.5)]"
          >
            {t('faqPage.heading')}
          </motion.h1>
          <motion.div
