// payment-request/page.tsx — server-side wrapper that loads the client-only booking page.
...
const PaymentRequestClient = dynamic(() => import('./PaymentRequestClient'), { ssr: false });
